		...
		<div class="row">
			<div class="col-lg-8 m-auto">
				<div class="block text-center">
					<h1>Better Language Transcription and Translation Services</h1>
					<p>Predictive analytics tools are being increasingly used by<br/>
					elecom companies for resource optimisation.
					</p>
